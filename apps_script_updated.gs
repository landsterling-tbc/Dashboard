...
const SHEET_NAMES = {
  ...
  fuelConsumption   : 'استهلاك_الوقود',   // ★ جديد
  vehicles          : 'السيارات',          // ★ جديد
  training          : 'برامج_التدريب',     // ★ جديد
};

// ── إعدادات الكاش ───────────────────────────────────────────────
const CACHE_SECONDS  = 600;
const CACHE_KEY_FULL = 'tbc_sheet_v3';   // ★ رُفِّع الإصدار لتفادي تعارض كاش قديم
...
function clearCache_(cache) {
  try {
    ...
    keys.push('tbc_sheet_v1', 'tbc_sheet_v1_chunks', 'tbc_sheet_v2', 'tbc_sheet_v2_chunks');
